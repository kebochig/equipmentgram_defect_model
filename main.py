...
async def startup_event():
    ...
    try:
        gemini_model = genai.GenerativeModel("gemini-2.5-flash-lite") #gemini-flash-latest  gemini-2.5-pro  gemini-2.5-flash gemini-3-flash-preview gemini-2.5-flash-lite
